            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about_text">
                        <h5>Siapa Kami?</h5>
                        <h2>Kami adalah teman perjalanan anda.</h2>
                        <p>Kami adalah Travel Buddy, kami ada untuk mempermudah anda memilih tujuan wisata yang anda inginkan. Wisata alam, tempat - tempat bersejarah, wisata religi, maupun wisata modern anda sendiri yang menentukan pilihan.</p>
                    </div>
                </div>
            </div>
        </div>
